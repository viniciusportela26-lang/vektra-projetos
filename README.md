...
- **Número de WhatsApp**: procurar e substituir todas as ocorrências de
  `934225828` em `index.html` (aparece em vários botões — nav, hero, projetos,
  serviços, secção CNC e contacto — todos apontam para o mesmo número).
